...
sys_env_destroy(envid_t envid)
{
  ...
  80012f:	68 ea 23 80 00       	push   $0x8023ea
  800134:	6a 23                	push   $0x23
  800136:	68 07 24 80 00       	push   $0x802407
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001bc:	68 ea 23 80 00       	push   $0x8023ea
  8001c1:	6a 23                	push   $0x23
  8001c3:	68 07 24 80 00       	push   $0x802407
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800202:	68 ea 23 80 00       	push   $0x8023ea
  800207:	6a 23                	push   $0x23
  800209:	68 07 24 80 00       	push   $0x802407
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800248:	68 ea 23 80 00       	push   $0x8023ea
  80024d:	6a 23                	push   $0x23
  80024f:	68 07 24 80 00       	push   $0x802407
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028e:	68 ea 23 80 00       	push   $0x8023ea
  800293:	6a 23                	push   $0x23
  800295:	68 07 24 80 00       	push   $0x802407
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d4:	68 ea 23 80 00       	push   $0x8023ea
  8002d9:	6a 23                	push   $0x23
  8002db:	68 07 24 80 00       	push   $0x802407
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80031a:	68 ea 23 80 00       	push   $0x8023ea
  80031f:	6a 23                	push   $0x23
  800321:	68 07 24 80 00       	push   $0x802407
...
sys_ipc_recv(void *dstva)
{
  ...
  800386:	68 ea 23 80 00       	push   $0x8023ea
  80038b:	6a 23                	push   $0x23
  80038d:	68 07 24 80 00       	push   $0x802407
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004b1:	8b 04 95 94 24 80 00 	mov    0x802494(,%edx,4),%eax
  ...
  8004c7:	51                   	push   %ecx
  8004c8:	50                   	push   %eax
  8004c9:	68 18 24 80 00       	push   $0x802418
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800735:	53                   	push   %ebx
  800736:	50                   	push   %eax
  800737:	68 59 24 80 00       	push   $0x802459
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800806:	53                   	push   %ebx
  800807:	50                   	push   %eax
  800808:	68 75 24 80 00       	push   $0x802475
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008b6:	53                   	push   %ebx
  8008b7:	50                   	push   %eax
  8008b8:	68 38 24 80 00       	push   $0x802438
...
00800ad6 <devfile_read>:
{
  ...
  800b2f:	c3                   	ret    
	assert(r <= n);
  800b30:	68 a8 24 80 00       	push   $0x8024a8
  800b35:	68 af 24 80 00       	push   $0x8024af
  800b3a:	6a 7c                	push   $0x7c
  800b3c:	68 c4 24 80 00       	push   $0x8024c4
  800b41:	e8 76 0a 00 00       	call   8015bc <_panic>
	assert(r <= PGSIZE);
  800b46:	68 cf 24 80 00       	push   $0x8024cf
  800b4b:	68 af 24 80 00       	push   $0x8024af
  800b50:	6a 7d                	push   $0x7d
  800b52:	68 c4 24 80 00       	push   $0x8024c4
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c13:	68 db 24 80 00       	push   $0x8024db
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80101a:	c3                   	ret    
		assert(r < 1600 && r <= len);
  80101b:	68 e7 24 80 00       	push   $0x8024e7
  801020:	68 af 24 80 00       	push   $0x8024af
  801025:	6a 62                	push   $0x62
  801027:	68 fc 24 80 00       	push   $0x8024fc
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80107c:	c3                   	ret    
	assert(size < 1600);
  80107d:	68 08 25 80 00       	push   $0x802508
  801082:	68 af 24 80 00       	push   $0x8024af
  801087:	6a 6d                	push   $0x6d
  801089:	68 fc 24 80 00       	push   $0x8024fc
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8010dd:	68 14 25 80 00       	push   $0x802514
  8010e2:	53                   	push   %ebx
...
00801141 <_pipeisclosed>:
{
  ...
  801184:	50                   	push   %eax
  801185:	53                   	push   %ebx
  801186:	68 1b 25 80 00       	push   $0x80251b
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80143b:	68 33 25 80 00       	push   $0x802533
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8015dc:	56                   	push   %esi
  8015dd:	50                   	push   %eax
  8015de:	68 40 25 80 00       	push   $0x802540
  ...
  8015ef:	e8 5a 00 00 00       	call   80164e <vcprintf>
	cprintf("\n");
  8015f4:	c7 04 24 2c 25 80 00 	movl   $0x80252c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80174f:	0f be 80 63 25 80 00 	movsbl 0x802563(%eax),%eax
  801756:	50                   	push   %eax
...
008017a6 <vprintfmt>:
{
  ...
  8018ce:	52                   	push   %edx
  8018cf:	68 c1 24 80 00       	push   $0x8024c1
  8018d4:	53                   	push   %ebx
  8018d5:	56                   	push   %esi
  ...
  8018e6:	50                   	push   %eax
  8018e7:	68 7b 25 80 00       	push   $0x80257b
  8018ec:	53                   	push   %ebx
  8018ed:	56                   	push   %esi
  ...
  80190e:	b8 74 25 80 00       	mov    $0x802574,%eax
