...
umain(int argc, char **argv)
{
  ...
  80006c:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  80006d:	50                   	push   %eax
  80006e:	68 66 2a 80 00       	push   $0x802a66
  800073:	6a 09                	push   $0x9
  800075:	68 80 2a 80 00       	push   $0x802a80
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800107:	56                   	push   %esi
  800108:	50                   	push   %eax
  800109:	68 a0 2a 80 00       	push   $0x802aa0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027a:	0f be 80 c3 2a 80 00 	movsbl 0x802ac3(%eax),%eax
  800281:	50                   	push   %eax
...
008002d1 <vprintfmt>:
{
  ...
  800411:	50                   	push   %eax
  800412:	68 db 2a 80 00       	push   $0x802adb
  800417:	53                   	push   %ebx
  800418:	56                   	push   %esi
  ...
  800439:	b8 d4 2a 80 00       	mov    $0x802ad4,%eax
