	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800203:	0f be 80 08 24 80 00 	movsbl 0x802408(%eax),%eax
  80020a:	50                   	push   %eax
...
0080025a <vprintfmt>:
{
  ...
  8002aa:	3e ff 24 85 40 25 80 	notrack jmp *0x802540(,%eax,4)
  8002b1:	00 
  ...
  800377:	8b 14 85 a0 26 80 00 	mov    0x8026a0(,%eax,4),%edx
  80037e:	85 d2                	test   %edx,%edx
  800380:	74 18                	je     80039a <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800382:	52                   	push   %edx
  800383:	68 d5 27 80 00       	push   $0x8027d5
  800388:	53                   	push   %ebx
  800389:	56                   	push   %esi
  ...
  80039a:	50                   	push   %eax
  80039b:	68 20 24 80 00       	push   $0x802420
  8003a0:	53                   	push   %ebx
  8003a1:	56                   	push   %esi
  ...
  8003c2:	b8 19 24 80 00       	mov    $0x802419,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4c:	68 ff 26 80 00       	push   $0x8026ff
  800b51:	6a 23                	push   $0x23
  800b53:	68 1c 27 80 00       	push   $0x80271c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd9:	68 ff 26 80 00       	push   $0x8026ff
  800bde:	6a 23                	push   $0x23
  800be0:	68 1c 27 80 00       	push   $0x80271c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c1f:	68 ff 26 80 00       	push   $0x8026ff
  800c24:	6a 23                	push   $0x23
  800c26:	68 1c 27 80 00       	push   $0x80271c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c65:	68 ff 26 80 00       	push   $0x8026ff
  800c6a:	6a 23                	push   $0x23
  800c6c:	68 1c 27 80 00       	push   $0x80271c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cab:	68 ff 26 80 00       	push   $0x8026ff
  800cb0:	6a 23                	push   $0x23
  800cb2:	68 1c 27 80 00       	push   $0x80271c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cf1:	68 ff 26 80 00       	push   $0x8026ff
  800cf6:	6a 23                	push   $0x23
  800cf8:	68 1c 27 80 00       	push   $0x80271c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d37:	68 ff 26 80 00       	push   $0x8026ff
  800d3c:	6a 23                	push   $0x23
  800d3e:	68 1c 27 80 00       	push   $0x80271c
...
sys_ipc_recv(void *dstva)
{
  ...
  800da3:	68 ff 26 80 00       	push   $0x8026ff
  800da8:	6a 23                	push   $0x23
  800daa:	68 1c 27 80 00       	push   $0x80271c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ece:	8b 04 95 a8 27 80 00 	mov    0x8027a8(,%edx,4),%eax
  ...
  800ee4:	51                   	push   %ecx
  800ee5:	50                   	push   %eax
  800ee6:	68 2c 27 80 00       	push   $0x80272c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801152:	53                   	push   %ebx
  801153:	50                   	push   %eax
  801154:	68 6d 27 80 00       	push   $0x80276d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801223:	53                   	push   %ebx
  801224:	50                   	push   %eax
  801225:	68 89 27 80 00       	push   $0x802789
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012d3:	53                   	push   %ebx
  8012d4:	50                   	push   %eax
  8012d5:	68 4c 27 80 00       	push   $0x80274c
...
008014f3 <devfile_read>:
{
  ...
  80154c:	c3                   	ret    
	assert(r <= n);
  80154d:	68 bc 27 80 00       	push   $0x8027bc
  801552:	68 c3 27 80 00       	push   $0x8027c3
  801557:	6a 7c                	push   $0x7c
  801559:	68 d8 27 80 00       	push   $0x8027d8
  80155e:	e8 76 0a 00 00       	call   801fd9 <_panic>
	assert(r <= PGSIZE);
  801563:	68 e3 27 80 00       	push   $0x8027e3
  801568:	68 c3 27 80 00       	push   $0x8027c3
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801630:	68 ef 27 80 00       	push   $0x8027ef
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801a37:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801a38:	68 fb 27 80 00       	push   $0x8027fb
  801a3d:	68 c3 27 80 00       	push   $0x8027c3
  801a42:	6a 62                	push   $0x62
  801a44:	68 10 28 80 00       	push   $0x802810
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801a9f:	68 c3 27 80 00       	push   $0x8027c3
  801aa4:	6a 6d                	push   $0x6d
  801aa6:	68 10 28 80 00       	push   $0x802810
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801afa:	68 28 28 80 00       	push   $0x802828
  801aff:	53                   	push   %ebx
...
00801b5e <_pipeisclosed>:
{
  ...
  801ba1:	50                   	push   %eax
  801ba2:	53                   	push   %ebx
  801ba3:	68 2f 28 80 00       	push   $0x80282f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801e58:	68 47 28 80 00       	push   $0x802847
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801ff9:	56                   	push   %esi
  801ffa:	50                   	push   %eax
  801ffb:	68 54 28 80 00       	push   $0x802854
  ...
  80200c:	e8 f1 e0 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  802011:	c7 04 24 fc 23 80 00 	movl   $0x8023fc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020d3:	eb e2                	jmp    8020b7 <ipc_send+0x20>
		if (r != -E_IPC_NOT_RECV) panic("ipc_send error %e", r);
  8020d5:	50                   	push   %eax
  8020d6:	68 77 28 80 00       	push   $0x802877
  8020db:	6a 39                	push   $0x39
  8020dd:	68 89 28 80 00       	push   $0x802889
